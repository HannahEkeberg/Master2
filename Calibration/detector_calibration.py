...
import os
path = os.getcwd()
cb_sp = npat.Spectrum(path +'/room131/text_Spe/BK20190208_Ba133_50cm_room131.Spe')
# cb_sp.plot()
...
cb_sp2 = npat.Spectrum(path +'/room131/text_Spe/BL20190207_Eu152_50cm_room131.Spe')
# cb_sp.plot()
...
cb_sp3 = npat.Spectrum(path +'/room131/text_Spe/BJ20190206_Cs137_50cm_room131.Spe')
# cb_sp.plot()
...
cb_sp.fit_config = {'xrays':True, 'E_min':Emin, 'bg_fit':True}
...
# cb_data = [[1890, 356.0]]#,
                        ...
                        # [2428, 444],
                        # [7698, 1408]]
cb_sp3.fit_config = {'xrays':True, 'E_min':Emin, 'bg_fit':True}
cb_sp2.fit_config = {'xrays':True, 'E_min':Emin, 'bg_fit':True, 'I_min':0.1}  # I_min: for X-ray fitting
...
sp = npat.Spectrum(path +'/room131/text_Spe/BK20190208_Ba133_50cm_room131.Spe')
# sp.meta = {'istp':['58CO','40K','210BI','212BI','210PB','212PB','226RA']}
sp.meta = {'istp':['133BA']}

prev_calib = list(sp.cb.engcal)
sp.fit_config = {'xrays':True,'E_min':Emin, 'bg_fit':True}
# , 'bg_fit':True}
#
# cb = npat.Calibration()
...
print(sp.cb.eff(700.0))
print(sp.cb.unc_eff(700.0))
print('% uncertainty: ', 100*sp.cb.unc_eff(700.0)/sp.cb.eff(700.0))
...
scipy.io.savemat('eff_room131_50.mat', {'popt_room131_50': sp.cb.effcal,'pcov_room131_50': sp.cb.unc_effcal})
