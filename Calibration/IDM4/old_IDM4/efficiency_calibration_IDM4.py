...
f_Cs137='AE20190131_Cs137_10cm_IDM4.sin'
f_Ba133='AF20190131_Ba133_10cm_IDM4.sin'
f_Eu152='AG20190131_Eu152_10cm_IDM4.sin'
#f_Na22='AD20190131_Na22_10cm_DetHPGE.sin'

date_spec= ["01/31/2019 12:56:41","01/31/2019 13:19:27","01/31/2019 14:10:21"]
real_time=np.array((623,2811,3708)) #seconds   
live_time=np.array((612,2741,3600)) #seconds 
...
plt.legend(['Cs137', 'Ba133', 'Eu152', 'Na22'], loc='best')
plt.title('Calibration of IDM4, Berkeley CA')
#plt.show()
...
plt.savefig('Calibration_IDM4', dpi=300)
plt.show()
...
A0= activity_test(np.log(2)/t_half[0],46652.0,eff_calibrated, 0.851, live_time[0] )  #with efficiency found from calibration curve

print (A0/np.exp(-lamb*time_delay[0]) ) *1e-3
