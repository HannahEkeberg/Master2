...
if __name__=='__main__':
	...
	#scaling_parameter = [0.97, 0.9875,
	scaling_parameter= [ 0.99, 0.9925]#, 0.995, 0.9975]
	...
	#	'D_-1,75', 'D_-1,5', 'D_-1,25',
	#names =	['D_-3', 'D_-1,25',
	names = ['D_-1', 'D_-0,75']#, 'D_-0,5', 'D_-0,25'] #, 'D_0', 'D_+0,25', 'D_+0,5', 'D_+0,75', 'D_+1','D_+1,25', 'D_+1,5',
