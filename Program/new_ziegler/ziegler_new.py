...
if __name__=='__main__':
	...
	#scaling_parameter = #[0.95, 0.9525, 0.955, 0.9575, 0.96, 0.9625, 0.965, 0.9675, 0.97, 0.9725,
	#scaling_parameter =[0.9725, 0.975, 0.9775, 0.98, 0.9825, 0.985]#,
	scaling_parameter = [0.995]
	...
	names = ['D_-0,5']
	#names = #['D_-5', 'D_-4,75', 'D_-4,5', 'D_-4,25', 'D_-4', 'D_-3,75', 'D_-3,5', 'D_-3,25', 'D_-3','D_-2,75',
	#names =	['D_-2,75',  'D_-2,5', 'D_-2,25', 'D_-2', 'D_-1,75', 'D_-1,5']#, 'D_-1,25', 'D_-1', 'D_-0,75', 'D_-0,5', 'D_-0,25', 'D_0', 'D_+0,25', 'D_+0,5', 'D_+0,75', 'D_+1','D_+1,25', 'D_+1,5',
